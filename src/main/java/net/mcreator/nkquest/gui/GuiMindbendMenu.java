...
import net.mcreator.nkquest.item.ItemBlankMindpage;
...
public class GuiMindbendMenu extends ElementsNkquest.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiMindbendMenu(ElementsNkquest instance) {
		super(instance, 145);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 71, 20) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 71, 47) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 71, 74) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 44, 74) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 17, 74) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 17, 47) {
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 17, 20) {
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 44, 47) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemBlankMindpage.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 116, 47) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nkquest:textures/mindbendmenu.png");
		@Override
