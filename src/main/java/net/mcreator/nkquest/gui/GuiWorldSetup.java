...
import net.mcreator.nkquest.procedure.ProcedureToCharacterScreen;
import net.mcreator.nkquest.procedure.ProcedureGuiClose;
...
public class GuiWorldSetup extends ElementsNkquest.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiWorldSetup(ElementsNkquest instance) {
		super(instance, 264);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Welcome to your newly created world! ", 29, 13, -1);
			this.fontRenderer.drawString("World Setup WIzard", 71, 1, -10066432);
			this.fontRenderer.drawString("Click \"NEXT\" to continue setup, or ", 34, 24, -1);
			this.fontRenderer.drawString("\"SKIP\" to close this GUI", 62, 35, -1);
			this.fontRenderer.drawString("(You can type \"/nkq setup\" to reopen this gui)", 5, 46, -1);
		}
		...
		public void initGui() {
			...
			this.guiTop = (this.height - 90) / 2;
			Keyboard.enableRepeatEvents(true);
			this.buttonList.clear();
			this.buttonList.add(new GuiButton(0, this.guiLeft + 30, this.guiTop + 63, 63, 20, "NEXT"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 147, this.guiTop + 63, 60, 20, "SKIP"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureToCharacterScreen.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
