...
import net.mcreator.nkquest.procedure.ProcedureConfrimCharReset;
...
public class GuiCharResetWarning extends ElementsNkquest.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiCharResetWarning(ElementsNkquest instance) {
		super(instance, 215);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Are you sure you wish to change your character? ", -28, -11, -1);
			this.fontRenderer.drawString("Your token will be removed!", 18, 1, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 25, this.guiTop + 25, 45, 20, "Confirm"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 106, this.guiTop + 25, 45, 20, "Back"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureConfrimCharReset.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
