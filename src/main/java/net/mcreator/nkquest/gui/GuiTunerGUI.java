...
public class GuiTunerGUI extends ElementsNkquest.ModElement {
	public static int GUIID = 17;
	public static HashMap guistate = new HashMap();
	public GuiTunerGUI(ElementsNkquest instance) {
		super(instance, 462);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nkquest:textures/tunergui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Crystal Tuner", 56, 4, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 115, this.guiTop + 20, 9, 20, ">"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 52, this.guiTop + 20, 9, 20, "<"));
			this.buttonList.add(new GuiButton(2, this.guiLeft + 70, this.guiTop + 47, 36, 20, "Tune"));
		}
