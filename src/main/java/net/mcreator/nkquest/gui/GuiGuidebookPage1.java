...
public class GuiGuidebookPage1 extends ElementsNkquest.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiGuidebookPage1(ElementsNkquest instance) {
		super(instance, 364);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("so how was school today.", 25, 74, -13382401);
		}
