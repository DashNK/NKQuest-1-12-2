...
public class GuiDashShellGUI extends ElementsNkquest.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiDashShellGUI(ElementsNkquest instance) {
		super(instance, 127);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 62, 30) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 80, 21) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 98, 30) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 62, 48) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 80, 39) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 98, 48) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 80, 57) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nkquest:textures/dashshellgui.png");
		@Override
