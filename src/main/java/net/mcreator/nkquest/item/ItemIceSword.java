...
import net.mcreator.nkquest.procedure.ProcedureIceStormTrigger;
...
public class ItemIceSword extends ElementsNkquest.ModElement {
	@GameRegistry.ObjectHolder("nkquest:icesword")
	public static final Item block = null;
	public ItemIceSword(ElementsNkquest instance) {
		super(instance, 495);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("nkquest:icesword", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureIceStormTrigger.executeProcedure($_dependencies);
			}
			return ar;
		}
