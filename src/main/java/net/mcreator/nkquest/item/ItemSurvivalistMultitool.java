...
public class ItemSurvivalistMultitool extends ElementsNkquest.ModElement {
	@GameRegistry.ObjectHolder("nkquest:survivalistmultitool")
	public static final Item block = null;
	public ItemSurvivalistMultitool(ElementsNkquest instance) {
		super(instance, 708);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("survivalistmultitool").setRegistryName("survivalistmultitool").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("nkquest:survivalistmultitool", "inventory"));
	}
