...
public class WorldMobius extends ElementsNkquest.ModElement {
	public static int DIMID = -8004;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldMobius(ElementsNkquest instance) {
		super(instance, 283);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension mobius is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("mobius", "_mobius", DIMID, WorldProviderMod.class, true);
