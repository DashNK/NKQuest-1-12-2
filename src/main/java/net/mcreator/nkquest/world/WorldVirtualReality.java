...
public class WorldVirtualReality extends ElementsNkquest.ModElement {
	public static int DIMID = 14;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldVirtualReality(ElementsNkquest instance) {
		super(instance, 579);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension virtualreality is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("virtualreality", "_virtualreality", DIMID, WorldProviderMod.class, true);
