...
import net.mcreator.nkquest.item.ItemTwilightRift;
import net.mcreator.nkquest.block.BlockServerPortalFrame;
import net.mcreator.nkquest.block.BlockRealityFabric;
...
public class WorldTwilightRift extends ElementsNkquest.ModElement {
	public static int DIMID = -8001;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("nkquest:twilightrift_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldTwilightRift(ElementsNkquest instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemTwilightRift().setUnlocalizedName("twilightrift").setRegistryName("twilightrift"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension twilightrift is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("twilightrift", "_twilightrift", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemTwilightRift.block, 0, new ModelResourceLocation("nkquest:twilightrift", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("twilightrift_portal");
			setRegistryName("twilightrift_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockRealityFabric.block.getDefaultState();
