...
import net.mcreator.nkquest.procedure.ProcedureGrantSoHowWasSchoolTodayAchievement;
import net.mcreator.nkquest.item.ItemTutorial;
...
public class WorldTutorial extends ElementsNkquest.ModElement {
	public static int DIMID = 15;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("nkquest:tutorial_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldTutorial(ElementsNkquest instance) {
		super(instance, 648);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemTutorial().setUnlocalizedName("tutorial").setRegistryName("tutorial"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension tutorial is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("tutorial", "_tutorial", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemTutorial.block, 0, new ModelResourceLocation("nkquest:tutorial", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureGrantSoHowWasSchoolTodayAchievement.executeProcedure($_dependencies);
			}
		}
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("tutorial_portal");
			setRegistryName("tutorial_portal");
			setLightLevel(0F);
		}
