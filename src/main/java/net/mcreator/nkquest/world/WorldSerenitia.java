...
public class WorldSerenitia extends ElementsNkquest.ModElement {
	public static int DIMID = -8003;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldSerenitia(ElementsNkquest instance) {
		super(instance, 282);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension serenitia is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("serenitia", "_serenitia", DIMID, WorldProviderMod.class, true);
