...
public class WorldOverskies extends ElementsNkquest.ModElement {
	public static int DIMID = -8004;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldOverskies(ElementsNkquest instance) {
		super(instance, 379);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension overskies is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("overskies", "_overskies", DIMID, WorldProviderMod.class, true);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("nkquest:@registryname")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:@registryname")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:@registryname")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:@registryname")),};
