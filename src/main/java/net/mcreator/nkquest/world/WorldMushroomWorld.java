...
public class WorldMushroomWorld extends ElementsNkquest.ModElement {
	public static int DIMID = -8005;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldMushroomWorld(ElementsNkquest instance) {
		super(instance, 284);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension mushroomworld is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("mushroomworld", "_mushroomworld", DIMID, WorldProviderMod.class, true);
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE2 = Blocks.DIRT.getDefaultState();
