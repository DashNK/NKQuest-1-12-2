...
import net.mcreator.nkquest.item.ItemLobby;
...
public class WorldLobby extends ElementsNkquest.ModElement {
	public static int DIMID = -8002;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("nkquest:lobby_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldLobby(ElementsNkquest instance) {
		super(instance, 281);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemLobby().setUnlocalizedName("lobby").setRegistryName("lobby"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension lobby is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("lobby", "_lobby", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemLobby.block, 0, new ModelResourceLocation("nkquest:lobby", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("lobby_portal");
			setRegistryName("lobby_portal");
			setLightLevel(1F);
		}
