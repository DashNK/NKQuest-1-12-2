...
import net.mcreator.nkquest.item.ItemCrypticArchipelago;
...
public class WorldCrypticArchipelago extends ElementsNkquest.ModElement {
	public static int DIMID = 13;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("nkquest:crypticarchipelago_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldCrypticArchipelago(ElementsNkquest instance) {
		super(instance, 387);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemCrypticArchipelago().setUnlocalizedName("crypticarchipelago").setRegistryName("crypticarchipelago"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension crypticarchipelago is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("crypticarchipelago", "_crypticarchipelago", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemCrypticArchipelago.block, 0,
				new ModelResourceLocation("nkquest:crypticarchipelago", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.380392156863, 0.823529411765, 1);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag
											? BlockServerPortalFrame.block.getDefaultState().getBlock().getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockServerPortalFrame.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("crypticarchipelago_portal");
			setRegistryName("crypticarchipelago_portal");
			setLightLevel(1F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockServerPortalFrame.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockServerPortalFrame.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockServerPortalFrame.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockServerPortalFrame.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE2 = Blocks.SAND.getStateFromMeta(0);
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("deep_ocean")),};
