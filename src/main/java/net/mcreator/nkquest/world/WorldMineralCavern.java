...
package net.mcreator.nkquest.world;
...
import net.mcreator.nkquest.item.ItemMineralCavern;
import net.mcreator.nkquest.block.BlockSilt;
...
public class WorldMineralCavern extends ElementsNkquest.ModElement {
	public static int DIMID = -8000;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("nkquest:mineralcavern_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldMineralCavern(ElementsNkquest instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemMineralCavern().setUnlocalizedName("mineralcavern").setRegistryName("mineralcavern"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension mineralcavern is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("mineralcavern", "_mineralcavern", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemMineralCavern.block, 0, new ModelResourceLocation("nkquest:mineralcavern", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.COAL_BLOCK.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("mineralcavern_portal");
			setRegistryName("mineralcavern_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.COAL_BLOCK.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.COAL_BLOCK.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.COAL_BLOCK
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockCrustrock.block.getDefaultState();
		private static final IBlockState STONE2 = BlockSilt.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("nkquest:lushcavern")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:mushroomcavern")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:stonecavern")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:sandycaves")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:chillycaves")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:drippingcaves")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:stickycaves")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:mineralcaves")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:webbedcaves")),
				Biome.REGISTRY.getObject(new ResourceLocation("nkquest:undeadcaves")),};
