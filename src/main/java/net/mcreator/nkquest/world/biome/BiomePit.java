...
public class BiomePit extends ElementsNkquest.ModElement {
	@GameRegistry.ObjectHolder("nkquest:pit")
	public static final BiomeGenCustom biome = null;
	public BiomePit(ElementsNkquest instance) {
		super(instance, 611);
	}
	...
	public void init(FMLInitializationEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.MOUNTAIN);
		BiomeManager.addSpawnBiome(biome);
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(biome, 4));
	}
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Pitlands").setRainfall(0.5F).setBaseHeight(-1.9F).setHeightVariation(0F).setTemperature(1F));
			setRegistryName("pit");
