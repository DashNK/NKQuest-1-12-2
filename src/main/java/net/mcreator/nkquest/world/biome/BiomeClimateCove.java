...
public class BiomeClimateCove extends ElementsNkquest.ModElement {
	@GameRegistry.ObjectHolder("nkquest:climatecove")
	public static final BiomeGenCustom biome = null;
	public BiomeClimateCove(ElementsNkquest instance) {
		super(instance, 626);
	}
	...
	public void init(FMLInitializationEvent event) {
		BiomeDictionary.addTypes(biome, BiomeDictionary.Type.COLD, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.MOUNTAIN);
		BiomeManager.addSpawnBiome(biome);
		BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(biome, 5));
	}
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Climate Cove").setRainfall(0.5F).setBaseHeight(0.3F).setWaterColor(-531263016).setHeightVariation(0F)
					.setTemperature(0.25F));
			setRegistryName("climatecove");
