...
public class StructureShimmeringTree2 extends ElementsNkquest.ModElement {
	public StructureShimmeringTree2(ElementsNkquest instance) {
		super(instance, 336);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "shimmeringtree2"));
				if (template == null)
					return;
