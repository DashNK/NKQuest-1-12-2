...
public class StructureCherryMoundTree3 extends ElementsNkquest.ModElement {
	public StructureCherryMoundTree3(ElementsNkquest instance) {
		super(instance, 333);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 960000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "cherrytree3"));
				if (template == null)
					return;
