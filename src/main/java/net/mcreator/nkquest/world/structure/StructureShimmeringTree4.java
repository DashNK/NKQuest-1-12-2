...
public class StructureShimmeringTree4 extends ElementsNkquest.ModElement {
	public StructureShimmeringTree4(ElementsNkquest instance) {
		super(instance, 338);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "shimmeringtree4"));
				if (template == null)
					return;
