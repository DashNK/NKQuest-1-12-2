...
public class StructureFlashingMushroom extends ElementsNkquest.ModElement {
	public StructureFlashingMushroom(ElementsNkquest instance) {
		super(instance, 346);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 900000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "flashingmushroom1"));
				if (template == null)
					return;
