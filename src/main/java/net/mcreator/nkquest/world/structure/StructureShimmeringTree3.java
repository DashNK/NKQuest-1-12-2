...
public class StructureShimmeringTree3 extends ElementsNkquest.ModElement {
	public StructureShimmeringTree3(ElementsNkquest instance) {
		super(instance, 337);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "shimmeringtree3"));
				if (template == null)
					return;
