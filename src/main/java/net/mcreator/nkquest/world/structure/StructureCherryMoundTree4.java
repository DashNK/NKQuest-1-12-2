...
public class StructureCherryMoundTree4 extends ElementsNkquest.ModElement {
	public StructureCherryMoundTree4(ElementsNkquest instance) {
		super(instance, 334);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 960000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "cherrytree4"));
				if (template == null)
					return;
