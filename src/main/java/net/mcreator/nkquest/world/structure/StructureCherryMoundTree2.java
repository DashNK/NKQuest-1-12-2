...
public class StructureCherryMoundTree2 extends ElementsNkquest.ModElement {
	public StructureCherryMoundTree2(ElementsNkquest instance) {
		super(instance, 332);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 960000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "cherrytree2"));
				if (template == null)
					return;
