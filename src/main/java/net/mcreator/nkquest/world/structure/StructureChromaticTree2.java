...
public class StructureChromaticTree2 extends ElementsNkquest.ModElement {
	public StructureChromaticTree2(ElementsNkquest instance) {
		super(instance, 345);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 800000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "chromatictree2"));
				if (template == null)
					return;
