...
public class StructureShimmeringTree1 extends ElementsNkquest.ModElement {
	public StructureShimmeringTree1(ElementsNkquest instance) {
		super(instance, 335);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("nkquest", "shimmeringtree-1"));
				if (template == null)
					return;
