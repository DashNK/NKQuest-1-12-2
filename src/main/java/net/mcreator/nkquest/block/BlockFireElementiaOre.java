...
import net.mcreator.nkquest.item.ItemFireElementia;
...
public class BlockFireElementiaOre extends ElementsNkquest.ModElement {
	@GameRegistry.ObjectHolder("nkquest:fireelementiaore")
	public static final Block block = null;
	public BlockFireElementiaOre(ElementsNkquest instance) {
		super(instance, 229);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fireelementiaore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nkquest:fireelementiaore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("fireelementiaore");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemFireElementia.block, (int) (1)));
		}
	}
}
