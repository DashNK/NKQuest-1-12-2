...
public class BlockOrangeLeaves extends ElementsNkquest.ModElement {
	@GameRegistry.ObjectHolder("nkquest:orangeleaves")
	public static final Block block = null;
	public BlockOrangeLeaves(ElementsNkquest instance) {
		super(instance, 87);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nkquest:orangeleaves", "inventory"));
	}
