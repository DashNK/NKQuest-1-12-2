...
package net.mcreator.nkquest.keybind;
...
public class KeyBindingOpenExternalInventory extends ElementsNkquest.ModElement {
	private KeyBinding keys;
	public KeyBindingOpenExternalInventory(ElementsNkquest instance) {
		super(instance, 128);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.openexternalinventory", Keyboard.KEY_V, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				Nkquest.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
