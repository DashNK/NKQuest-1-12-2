...
import net.mcreator.nkquest.procedure.ProcedureSwitchAbility;
import net.mcreator.nkquest.Nkquest;
import net.mcreator.nkquest.ElementsNkquest;

@ElementsNkquest.ModElement.Tag
public class KeyBindingMode extends ElementsNkquest.ModElement {
	private KeyBinding keys;
	public KeyBindingMode(ElementsNkquest instance) {
		super(instance, 70);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.mode", Keyboard.KEY_BACKSLASH, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureSwitchAbility.executeProcedure($_dependencies);
		}
	}
}
