...
import net.mcreator.nkquest.procedure.ProcedureActionManager;
import net.mcreator.nkquest.Nkquest;
import net.mcreator.nkquest.ElementsNkquest;

@ElementsNkquest.ModElement.Tag
public class KeyBindingAction extends ElementsNkquest.ModElement {
	private KeyBinding keys;
	public KeyBindingAction(ElementsNkquest instance) {
		super(instance, 262);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.action", Keyboard.KEY_PERIOD, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureActionManager.executeProcedure($_dependencies);
		}
	}
}
