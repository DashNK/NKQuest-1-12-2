...
import net.mcreator.nkquest.procedure.ProcedureSpecialActions;
import net.mcreator.nkquest.Nkquest;
import net.mcreator.nkquest.ElementsNkquest;

@ElementsNkquest.ModElement.Tag
public class KeyBindingSpecialActionKey extends ElementsNkquest.ModElement {
	private KeyBinding keys;
	public KeyBindingSpecialActionKey(ElementsNkquest instance) {
		super(instance, 501);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.specialactionkey", Keyboard.KEY_COMMA, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureSpecialActions.executeProcedure($_dependencies);
		}
	}
}
