...
public class ProcedureFallToOverworld extends ElementsNkquest.ModElement {
	public ProcedureFallToOverworld(ElementsNkquest instance) {
		super(instance, 385);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure FallToOverworld!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if ((((entity.posY) < 0) && ((entity.dimension) == -8006))) {
